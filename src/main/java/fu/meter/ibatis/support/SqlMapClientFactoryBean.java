...
package fu.meter.ibatis.support;
...
public class SqlMapClientFactoryBean implements FactoryBean, InitializingBean {
	 ...
	 * @see #setLobHandler
	 * @see fu.meter.ibatis.support.ClobStringTypeHandler
	 * @see fu.meter.ibatis.support.BlobByteArrayTypeHandler
	 * @see fu.meter.ibatis.support.BlobSerializableTypeHandler
	 */
